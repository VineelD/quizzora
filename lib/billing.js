...
import { isFreeAccessMode, isPaidSubscriptionsEnabled } from "./billing-mode.js";
...
export function isStripeConfigured() {
  return isPaidSubscriptionsEnabled();
}
...
export function initSchoolFreeAccess(db, schoolId) {
  db.prepare(
    `
    UPDATE schools
    SET
...
export function initSchoolTrial(db, schoolId) {
  if (isFreeAccessMode()) {
    initSchoolFreeAccess(db, schoolId);
    return;
  }
