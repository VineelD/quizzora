...
const WIDE_DIAGRAM_TYPES = new Set(["number_line", "timeline", "process_diagram", "circuit_diagram"]);
...
export function aspectLayoutHint(diagramType) {
  ...
  if (type === "circuit_diagram") {
    return "Use a wide horizontal layout — battery on the left, branches stacked vertically, standard circuit symbols (not ASCII text).";
  }
